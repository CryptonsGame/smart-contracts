...
var AbstractQuintessenceToken = artifacts.require('AbstractQuintessenceToken');
...
contract('ERC827 Token', function (accounts) {
  ...
  beforeEach(async function () {
    token = await AbstractQuintessenceToken.new(100, cap);
  });
  ...
  it('should return the correct allowance amount after approval', async function () {
    let token = await AbstractQuintessenceToken.new(100, cap);
